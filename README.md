...
**Objetivo:**  
Repositório educacional para aprender como simular um Ataque de Brute Force de Senhas com Medusa, Kali Linux e Metaspliotable 2.0 em um ambiente de laboratório isolado. ⚠️ **Atenção** Este repositório **não** contém instruções para realizar ataques. Use apenas em ambientes com autorização.
